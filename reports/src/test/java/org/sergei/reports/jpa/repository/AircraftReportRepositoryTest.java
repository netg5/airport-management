...
import org.sergei.reports.testconfig.WebSecurityConfigTest;
...
@EnableJpaRepositories(basePackages = "org.sergei.reports.jpa.repository")
@EntityScan(basePackages = "org.sergei.reports.jpa.model")
