...
package org.sergei.reports.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.reports.jpa.repository..*)" +
            " || within(org.sergei.reports.service..*)" +
            " || within(org.sergei.reports.rest..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.reports.jpa.repository.*.*(..))" +
            " || execution(* org.sergei.reports.service.*.*(..))" +
            " || execution(* org.sergei.reports.rest.*.*(..))")
