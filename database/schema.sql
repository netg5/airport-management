...
(
    ...
    capacity            INTEGER CHECK (capacity <= 5)            NOT NULL,
    weight              DOUBLE PRECISION                         NOT NULL,
    exploitation_period INTEGER CHECK (exploitation_period <= 5) NOT NULL,
...
(
    ...
    age        INTEGER CHECK (age <= 3) NOT NULL,
    phone      NUMERIC(25)              NOT NULL,
...
(
    id            BIGINT                          NOT NULL,
    day_number    INTEGER CHECK (day_number <= 2) NOT NULL,
    day_date      INTEGER CHECK (day_date <= 2)   NOT NULL,
