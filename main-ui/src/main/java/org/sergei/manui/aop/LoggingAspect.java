...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.manui.service..*)" +
            " || within(org.sergei.manui.controller..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.manui.service.*.*(..))" +
            " || execution(* org.sergei.manui.controller.*.*(..))")
