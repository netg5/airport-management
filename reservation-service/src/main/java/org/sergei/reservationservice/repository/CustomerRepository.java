...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
     ...
     * @return list of IDs
     */
    @Query("SELECT NEW org.sergei.reservationservice.rest.dto.CustomerIdsDTO(c.customerId) FROM Customer c")
     ...
     */
    @Query(value = "SELECT NEW org.sergei.reservationservice.rest.dto.CustomerIdsDTO(c.customerId) FROM Customer c",
