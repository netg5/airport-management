...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.reservation.jpa.repository..*)" +
            " || within(org.sergei.reservation.service..*)" +
            " || within(org.sergei.reservation.rest..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.reservation.jpa.repository.*.*(..))" +
            " || execution(* org.sergei.reservation.service.*.*(..))" +
            " || execution(* org.sergei.reservation.rest.*.*(..))")
