...
package org.sergei.frontendservice.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.frontendservice.service..*)" +
            " || within(org.sergei.frontendservice.controller..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.frontendservice.service.*.*(..))" +
            " || execution(* org.sergei.frontendservice.controller.*.*(..))")
