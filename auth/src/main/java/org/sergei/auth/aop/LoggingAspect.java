...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.auth.jpa.repository..*)" +
            " || within(org.sergei.auth.service..*)" +
            " || within(org.sergei.auth.rest..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.auth.jpa.repository.*.*(..))" +
            " || execution(* org.sergei.auth.service.*.*(..))" +
            " || execution(* org.sergei.auth.rest.*.*(..))")
