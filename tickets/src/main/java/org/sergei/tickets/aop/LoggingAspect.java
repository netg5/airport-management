...
package org.sergei.tickets.aop;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("within(org.sergei.tickets.jpa.repository..*)" +
            " || within(org.sergei.tickets.service..*)" +
            " || within(org.sergei.tickets.rest..*)")
    public void applicationPackagePointcut() {
        // Method is empty as this is just a Pointcut, the implementations are in the advices.
    }

    @Pointcut("execution(* org.sergei.tickets.jpa.repository.*.*(..))" +
            " || execution(* org.sergei.tickets.service.*.*(..))" +
            " || execution(* org.sergei.tickets.rest.*.*(..))")
